...
get '/users/:user_id/assigned_qa',to:'users#show_assigned_creators' ,as:'show_specific_creator'
get '/users/:user_id/assigned_developer',to:'users#show_assigned_developers' ,as:'show_specific_developer'
